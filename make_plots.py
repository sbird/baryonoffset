...
#     ax.semilogx(kf1, spkf1/spkf2, ls="-", label=r"without DLAs removed", color="blue")
    ...
    ax.set_xlim(left=0.001,right=0.05)
    ax.vlines([0.00141,0.01778], ymin=0.85, ymax=1.15, linestyles="dashed")
    ...
    ax.loglog(kf1, pkf2, ls="-", label=r"Total transfer", color="blue")
    ax.set_xlabel(r"$k_\mathrm{F}$ (s/km)")
