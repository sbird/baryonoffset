...
I guess this is simulation jargon, but I'd try to find an alternative way to explain it.} \YF{I think it may be equal fractional mass resolution with a footnote defining it is equal particle mean separation.}
...
\end{tabular}
\end{center}
\caption{Table of simulations. Box size is in comoving Mpc/h. $\sigma_8 = 0.008$ throughout. \YF{0.008? would mean glass noise is very very high.}}
...
\YF{And Yin Li who suggested me to implement the damping term, and validated the initial glass implementation with me.})
