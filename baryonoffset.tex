...
The right panel of Figure~\ref{fig:lyaflux} shows the flux power spectrum ratios after this rescaling. The effects are now much smaller, on the order of $5\%$. This is comparable to the $1\sigma$ statistical errors on the BOSS DR9 1D flux power spectrum used to generate existing cosmological constraints \cite{PD2013}. The effect of species dependent transfer functions thus should not affect the broad conclusions of existing constraints. However, it is larger than the $2-4\%$ statistical error achieved in the newest DR14 data release of Ref.~\cite{Chabanier:2019} and should be taken into account in future cosmological analyses using this data set.
...
We find that it does at the $5-10\%$ level. While this is comparable to the $1\sigma$ statistical errors used in \cite{PD2013}, it is larger than the $2-4\%$ statistical error achieved by Ref.~\cite{Chabanier:2019} and should be taken into account in future cosmological analyses using this data set.
